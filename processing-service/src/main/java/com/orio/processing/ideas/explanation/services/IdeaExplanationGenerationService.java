...
import com.orio.processing.ideas.explanation.models.LogicMapperExplanationResponse;
...
public class IdeaExplanationGenerationService {
    ...
    private static final String IDEA_EXPLANATION_PROMPT = """
            ...
            2. Look for the "premises" â€” the sentences immediately preceding or following the concept that act as setup or justification.
            3. Look for "connectors" â€” words like "because," "therefore," "due to," or examples that illustrate the concept.
